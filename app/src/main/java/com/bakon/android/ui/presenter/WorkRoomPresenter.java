...
public class WorkRoomPresenter implements WorkRoomContact.Presenter {
    ...
    public void getRedPointStatus() {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().getHomeRedPointStatus(params))
                .compose(mView.toLifecycle())
                .subscribe(new BaseObserver<HttpResponse<OtherBean>>(null) {
                    @Override
                    public void onSubscribe(Disposable d) {
...
//                        mView.onError(errorCode, errorMsg);
    ...
    public void getHomeBanner() {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().getHomeBanner(params))
                .compose(mView.toLifecycle())
                ...
                .subscribe(new BaseObserver<HttpResponse<List<BannerBean>>>(mDialog) {
                    ...
                    public void onSuccess(HttpResponse<List<BannerBean>> personalBeanHttpResponse) {
                        mView.onSuccess(MSG.createMessage(personalBeanHttpResponse.data, GET_BANNER_OK));
                    }
    ...
    public void getOPenPaperBaseData() {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().getSomeadvisory(params))
                .compose(mView.toLifecycle())
...
//                        mView.onSuccess(MSG.createMessage(personalBeanHttpResponse.data, GET_BASEDATA_0K));
                    }
    ...
    public void updataToken() {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().updateToken(params))
                .compose(mView.toLifecycle())
                .doOnSubscribe(disposable -> {
                    if (mDialog != null)
                        mDialog.show();
...
//                        mView.onError(errorCode, errorMsg);
    ...
    public void bindXGToken(String xgToken) {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().bindXGToken(params))
    ...
    public void getSystemMsgList(int page) {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().getSystemMsglist(params))
                .compose(mView.toLifecycle())
                .subscribe(new BaseObserver<HttpResponse<BasePageBean<SystemMsgBean>>>(null) {
                    ...
                    public void onSuccess(HttpResponse<BasePageBean<SystemMsgBean>> response) {
                        mView.onSuccess(MSG.createMessage(response.data, GET_SYSTEMMSG_LIST_OK));
                    }
    ...
    public void getJobScheduleList() {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().getJobScheduleList(params))
                .compose(mView.toLifecycle())
                .subscribe(new BaseObserver<HttpResponse<List<JobScheduleBean>>>(null) {
                    ...
                    public void onSuccess(HttpResponse<List<JobScheduleBean>> response) {
                        mView.onSuccess(MSG.createMessage(response.data, GET_JOBSCHEDULE_LIST_OK));
                    }
    ...
    public void getJobSchedulePatientList(String date, int store_id, int type) {
        ...
        params.put(HttpConfig.SIGN_KEY, params.getSign(params));
        MyApplication.getAppComponent().dataRepo().http()
                .wrapper(MyApplication.getAppComponent().dataRepo().http().provideHttpAPI().getJobSchedulePatientList(params))
                .compose(mView.toLifecycle())
                .subscribe(new BaseObserver<HttpResponse<List<JobSchedulePatientBean>>>(null) {
                    ...
                    public void onSuccess(HttpResponse<List<JobSchedulePatientBean>> response) {
                        mView.onSuccess(MSG.createMessage(response.data, type == 1 ? GET_JOBSCHEDULE_PATIENT_COMPLETE : GET_JOBSCHEDULE_PATIENT_CANCLE));
                    }
