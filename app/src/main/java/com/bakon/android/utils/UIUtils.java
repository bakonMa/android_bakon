...
public class UIUtils {
    ...
    public static int getColor(int res) {
        return ContextCompat.getColor(MyApplication.getInstance(), res);
    }
    ...
    public static String getString(int res) {
        return MyApplication.getInstance().getResources().getString(res);
    }
    /**
     * 获取String
     */
    public static String[] getArray(int res) {
        return MyApplication.getInstance().getResources().getStringArray(res);
    }
    ...
    public static Drawable getDrawable(int res) {
        return ContextCompat.getDrawable(MyApplication.getInstance(), res);
    }
    ...
    public static void setCompoundDrawable(View view, int widthdp, int paddingdp, int resId, int gravity) {
        if (resId > 0) {
            int width = dp2px(MyApplication.getInstance(), widthdp);
            ...
            if (view instanceof TextView) {
                ...
                compoundView.setCompoundDrawablePadding(dp2px(MyApplication.getInstance(), paddingdp));
