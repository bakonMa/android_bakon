...
public class RechargeSuccessActivity extends BaseAppCompatActivity {
    ...
    public void onViewClicked() {
        MyAccountInfoBean.UserAccountInfoDTOBean bean = (MyAccountInfoBean.UserAccountInfoDTOBean) CustomerApplication.getAppComponent().sessionMap().get(SessionMapKey.RECHAGE_BEAN);
        if (bean == null) {
            finish();
        } else {
