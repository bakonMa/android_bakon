package com.jht.doctor.ui.activity.login;
 ...
 */
public class RegisteActivity extends BaseActivity implements RegisteContact.View {
    ...
    public void onSuccess(Message message) {
        ...
        switch (message.what) {
            case RegistePresenter.SEND_CODE://注册 发送短信成功
                timeDown();
                break;
            case RegistePresenter.REGISTE_SUCCESS://注册成功
