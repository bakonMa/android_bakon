package com.junhetang.doctor.nim.message;
...
import com.junhetang.doctor.nim.DocCache;
import com.junhetang.doctor.nim.action.AskPaperAction;
import com.junhetang.doctor.nim.action.CloseChatAction;
import com.junhetang.doctor.nim.action.FollowPaperAction;
import com.junhetang.doctor.nim.action.OpenPaperCameraAction;
import com.junhetang.doctor.nim.action.OpenPaperOnlineAction;
import com.junhetang.doctor.nim.action.PhotoAction;
import com.junhetang.doctor.nim.action.QuickReplyAction;
...
import com.junhetang.doctor.nim.message.extension.CustomAttachParser;
import com.junhetang.doctor.nim.message.extension.CustomAttachment;
...
import com.junhetang.doctor.nim.message.extension.RedPacketAttachment;
...
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderAskPaper;
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderCloseChat;
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderDefCustom;
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderFirstMessage;
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderFollowPaper;
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderOpenPaperCamera;
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderSticker;
import com.junhetang.doctor.nim.message.viewholder.MsgViewHolderTip;
import com.junhetang.doctor.ui.nimview.P2PChatActivity;
...
//            p2pCustomization.buttons = buttons;
    ...
    private static void registerViewHolders() {
        NimUIKit.registerMsgItemViewHolder(FirstMessageAttachment.class, MsgViewHolderFirstMessage.class);//第一条消息（患者信息）
        ...
        NimUIKit.registerMsgItemViewHolder(OPenPaperAttachment.class, MsgViewHolderOpenPaperCamera.class);//拍照开方
            ...
            public boolean shouldIgnore(IMMessage message) {
                if (message.getDirect() == MsgDirectionEnum.In
                    ...
                    return true;
                        ...
                        || message.getAttachment() instanceof FirstMessageAttachment//第一条消息
                        || message.getAttachment() instanceof AskPaperAttachment//问诊单
                        || message.getAttachment() instanceof FollowPaperAttachment//随诊单
                        || message.getAttachment() instanceof OPenPaperAttachment//拍照开方
