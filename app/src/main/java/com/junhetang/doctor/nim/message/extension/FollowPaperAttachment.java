...
/**
 * FollowPaperAttachment 随诊单
 * Create at 2018/4/17 下午5:50 by mayakun
 */
public class FollowPaperAttachment extends CustomAttachment {
    ...
    private String linkID;// 跳转随诊单ID

    public FollowPaperAttachment() {
        super(CustomAttachmentType.MESSAGE_FOllOW_PAPER);
