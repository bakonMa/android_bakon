package com.junhetang.doctor.nim.event;
...
public class OnlineStateEventManager {
    ...
    private static void registerNetTypeChangeObserver() {
        ...
        DocCache.getContext().registerReceiver(receiver, filter);
    }
    ...
    public static void publishOnlineStateEvent(boolean force) {
        ...
        int netState = getNetWorkTypeName(DocCache.getContext());
    ...
    private static boolean enableOnlineStateEvent() {
        String packageName = DocCache.getContext().getPackageName();
